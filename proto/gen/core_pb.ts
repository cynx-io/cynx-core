...
export const file_core: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp]);
...
export type BaseRequest = Message<"core.BaseRequest"> & {
  ...
  /**
   * @generated from field: core.ChannelType channel = 8;
   */
  channel: ChannelType;
};
...
export enum ChannelType {
  ...
  /**
   * @generated from enum value: BIBLE_APP = 1;
   */
  BIBLE_APP = 1,
}

...
const (
	FileService_UploadFile_FullMethodName           = "/core.FileService/UploadFile"
	FileService_GeneratePresignedURL_FullMethodName = "/core.FileService/GeneratePresignedURL"
)

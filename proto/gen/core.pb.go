...
type BaseRequest struct {
	...
	Channel       ChannelType            `protobuf:"varint,8,opt,name=channel,proto3,enum=core.ChannelType" json:"channel,omitempty"`
...
func (x *BaseRequest) GetChannel() ChannelType {
	if x != nil {
		return x.Channel
	}
	return ChannelType_PERINTIS_COURSE
}
...
const file_core_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"core.proto\x12\x04core\x1a\x1fgoogle/protobuf/timestamp.proto\"\xca\x02\n" +
	...
	"\tuser_type\x18\a \x01(\x05H\x02R\buserType\x88\x01\x01\x12+\n" +
	"\achannel\x18\b \x01(\x0e2\x11.core.ChannelTypeR\achannelB\n" +
	"\n" +
	"\b_user_idB\v\n" +
	"\t_usernameB\f\n" +
	"\n" +
...
var file_core_proto_depIdxs = []int32{
	0, // 0: core.BaseRequest.channel:type_name -> core.ChannelType
	1, // 1: core.BaseResponse.status:type_name -> core.Status
	2, // 2: core.GenericRequest.base:type_name -> core.BaseRequest
	3, // 3: core.GenericResponse.base:type_name -> core.BaseResponse
	2, // 4: core.UploadFileRequest.base:type_name -> core.BaseRequest
	3, // 5: core.UploadFileResponse.base:type_name -> core.BaseResponse
	2, // 6: core.GeneratePresignedURLRequest.base:type_name -> core.BaseRequest
	3, // 7: core.GeneratePresignedURLResponse.base:type_name -> core.BaseResponse
